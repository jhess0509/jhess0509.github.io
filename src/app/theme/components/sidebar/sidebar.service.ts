...
export class SidebarService {
    ...
    public createSidebarMenu(menu: Array<SidebarItem>, nativeElement: any) {    
    ...
    public createSidebarItem(menu:Array<SidebarItem>, sidebarItem: any) {
    ...
    private createSubMenu(menu: Array<SidebarItem>, menuItemId: number , parentElement: any){
    ...
    public setActiveLink(menu:Array<SidebarItem>, link: any){
        if (link) {
            menu.forEach((menuItem) => {
